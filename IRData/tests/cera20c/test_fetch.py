...
class TestFetch(unittest.TestCase):
    ...
    def test_fetch_prmsl(self):
        with patch.object(
            ...
            cera20c.fetch("prmsl", datetime.datetime(1969, 3, 12))
        mock_method.assert_called_once_with(
            {
                ...
                "class": "ep",
                "target": "%s/CERA_20C/hourly/1969/03/prmsl.nc" % os.getenv("SCRATCH"),
                "param": "mslp",
        ...
        mock_method.assert_any_call(
            {
                ...
                "date": "1969-03-01/to/1969-03-31",
                "format": "netcdf",
                "target": "%s/CERA_20C/hourly/1969/03/prate.nc" % os.getenv("SCRATCH"),
            }
        )
    ...
    def test_fetch_prmsl_eom(self):
        with patch.object(
            ...
            cera20c.fetch("prmsl", datetime.datetime(1969, 3, 31, 21))
        mock_method.assert_called_with(
            {
                "stream": "enda",
                "format": "netcdf",
        ...
        mock_method.assert_any_call(
            {
                ...
                "class": "ep",
                "target": "%s/CERA_20C/hourly/1969/04/prmsl.nc" % os.getenv("SCRATCH"),
                "param": "mslp",
                "time": "00/03/06/09/12/15/18/21",
                "type": "an",
            }
    ...
    def test_fetch_mslp(self):
        with self.assertRaises(Exception) as cm:
            cera20c.fetch("mslp", datetime.datetime(1969, 3, 12))
