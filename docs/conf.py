...
#
html_title = 'An API for accessing synoptic-timescale reanalyis data'

# A shorter title for the navigation bar.  Default is the same as html_title.
#
html_short_title = 'IRData'
...
latex_documents = [
    (master_doc, 'IRData.tex', 'IRData Documentation',
...
man_pages = [
    (master_doc, 'IRData', 'IRData Documentation',
     [author], 1)
]
